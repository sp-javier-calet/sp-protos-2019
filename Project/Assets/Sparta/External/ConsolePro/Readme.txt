...
# Custom icons:
Standard and custom filters can have custom icons.  If you would like pixel perfect icons, please make them 13x13 like the example icons provided in the ConsolePro\Icons folder.  Any icons that are higher or lower resolution will be shrunk to this size and bilinear filtered.

# Shared settings:
Shared settings are custom settings in an external file.  These are per project, so you can set a different set of settings for each project you are in, and also commit this file to version control if you would like other people to use them.
You can create and modify these in Prefs\Shared Settings
