...
namespace Jitter.Collision
{
    ...
    class IslandManager : ReadOnlyCollection<CollisionIsland>
    {
        ...
        {
            System.Diagnostics.Debug.Assert((body1 != null && !body1.IsStaticNonKinematic) || (body2 != null && !body2.IsStaticNonKinematic), 
        ...
        {
            System.Diagnostics.Debug.Assert(!(body1.IsStaticNonKinematic && body2.IsStaticNonKinematic),
                "IslandManager Inconsistency.",
            ...
            {
                System.Diagnostics.Debug.Assert(body1.island == body2.island, "IslandManager Inconsistency.", "Removing arbiter with different islands.");
                body1.connections.Remove(body2);
                body2.connections.Remove(body1);
