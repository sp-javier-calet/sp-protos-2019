...
namespace AssetBundleGraph
{
    ...
    public class FilterEntry
    {
        ...
        [SerializeField]
        private string m_filterKeytype;
        [SerializeField]
        private bool m_isExclusion;
        [SerializeField]
        private ConnectionPointData m_point;
    ...
    public class NodeData
    {
        ...
        [SerializeField]
        private SerializableMultiTargetString m_loaderLoadPath;
        [SerializeField]
        private SerializableMultiTargetString m_exporterExportPath;
        [SerializeField]
        private SerializableMultiTargetString m_groupingKeyword;
        [SerializeField]
        private SerializableMultiTargetString m_bundleConfigBundleNameTemplate;
        [SerializeField]
        private SerializableMultiTargetString m_scriptInstanceData;
        [SerializeField]
        private List<Variant> m_variants;
        [SerializeField]
        private bool m_bundleConfigUseGroupAsVariants;
        [SerializeField]
        private SerializableMultiTargetInt m_bundleBuilderEnabledBundleOptions;
        [SerializeField]
        private SerializableMultiTargetInt m_exporterExportOption;
