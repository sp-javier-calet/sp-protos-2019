...
namespace SocialPoint.Multiplayer
{
    public class MultiplayerTestMonoBehaviour : MonoBehaviour, INetworkSceneBehaviour
    {
        ...
        void Start()
        {
            ...
            _clientController.RegisterBehaviour(new UnityNetworkClientDebugBehaviour().Init(_clientController, _serverController));
        ...
        void INetworkSceneBehaviour.OnInstantiateObject(NetworkGameObject go)
        {
            ...
            if(cgo != null && _serverController != null)
            {
                ...
                if(serverGo != null)
                {
                    ...
                    if(rigid != null)
                    {
                        cgo.AddBehaviour(new UnityDebugNetworkClientRigidBody().Init(_serverController, _clientController));
                    }
                }
            }
        }
