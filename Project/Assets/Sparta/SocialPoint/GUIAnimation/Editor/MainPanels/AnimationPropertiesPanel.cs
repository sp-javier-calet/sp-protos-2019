    ...
    public class AnimationPropertiesPanel
    {
        ...
        void RegisterMonitorChangesTime()
        {
            if(_monitorController.Monitor(_firedMonitors))
            {
                ...
                {
                    MonitorChangedEventData monitorChangedEventData = _monitorChangedEventDatas.Find((MonitorChangedEventData adata) => {
                        return adata.EffectType == _firedMonitors[i].StepType;
                    });
        ...
        void DoRenderEffectsList()
        {
            ...
            else
            {
                ...
                for(int i = 0; i < blendActions.Count; ++i)
                {
                    ...
                    MonitorChangedEventData monitor = _monitorChangedEventDatas.Find((MonitorChangedEventData mdata) => {
                        return mdata.EffectType == currentEffectType;
                    });
                    if(monitor != null)
                    {
        ...
        {
            return StepsManager.BlendStepsData.Find((StepData adata) => {
