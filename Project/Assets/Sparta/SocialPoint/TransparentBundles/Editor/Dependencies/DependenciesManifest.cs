...
public class DependenciesManifest
{
    ...
    public Dictionary<string, BundleDependenciesData> manifest = new Dictionary<string, BundleDependenciesData>();

    [System.NonSerialized]
    static DependenciesManifest _instance;
    public static DependenciesManifest GetInstance()
    {
        if(_instance == null)
        {
            if(File.Exists(path))
            {
                _instance = JsonMapper.ToObject<DependenciesManifest>(File.ReadAllText(path));
            }
            else
            {
                _instance = new DependenciesManifest();
            }
        }
    ...
    public BundleDependenciesData GetDependencyData(string GUID)
    {
    ...
    public void AddAssetsWithDependencies(string GUID, string bundleName)
    {
    ...
    public void RemoveAssetWithDependencies(string GUID)
    {
        if(HasAsset(GUID))
        {
            var objPath = AssetDatabase.GUIDToAssetPath(GUID);
    ...
    public void AssignBundle(string GUID, string bundleName)
    {
    ...
    public void RemoveSingleAsset(string GUID)
    {
        if(HasAsset(GUID))
        {
    ...
    public List<string> GetBundleIDs(string GUID)
    {
    ...
    public Dictionary<string, BundleDependenciesData> GetAllParentsBundled(string guid)
    {
    ...
    #region Dependencies
    public List<string> GetListOfDependencies(string objPath)
    {
    ...
    public void AddAssetDependency(string GUID, string dependency, List<string> dependenciesToRemove = null)
    {
        BundleDependenciesData data = null;
        List<string> listDependencies = null;
    ...
    public void RemoveDependency(string GUID, string dependency, List<string> dependenciesToAdd = null)
    {
        if(HasAsset(GUID))
        {
    ...
    #region Parenthood
    public List<string> GetBundleChildren(string bundleName)
    {
    ...
    List<string> GetChildsRecursive(BundleDependenciesData dependencyData)
    {
    ...
    public string GetBundleParent(string bundleName)
    {
        string parentBundle = "";
