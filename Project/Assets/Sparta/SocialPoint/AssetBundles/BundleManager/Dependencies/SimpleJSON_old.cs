...
namespace SimpleJSON_old
{
    ...
    public class JSONNode
    {
        ...
        public IEnumerable<JSONNode> DeepChilds
        {
            get
            {
                ...
                {
                    JSONNode C = Childs.ElementAt(k);
                    for(int z = 0; z < C.DeepChilds.Count(); z++)
                    {
                        yield return C.DeepChilds.ElementAt(z);
                    }
                }
            }
        }
    ...
    public sealed class JSONClass : JSONNode, IEnumerable
    {
        ...
        public override IEnumerable<JSONNode> Childs
        {
            get
            {
                for(int k = 0; k < m_Dict.Count; k++)
                {
                    KeyValuePair<string,JSONNode> N = m_Dict.ElementAt(k);
        ...
        public override void Serialize (System.IO.BinaryWriter aWriter)
        {
            ...
            string[] keys = m_Dict.Keys.ToArray();
