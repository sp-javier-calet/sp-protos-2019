...
{
    public abstract class ActionPointerInputModule : BaseInputModule
    {
        ...
        protected PointerEventData GetTouchPointerEventData(UnityEngine.Touch input, out bool pressed, out bool released)
        {
            ...
            var actionEventSystem = eventSystem as ActionEventSystem;
            if(actionEventSystem != null)
            {
                actionEventSystem.RaycastCamera(pointerData, m_RaycastResultCache);
            }
        ...
        protected virtual MouseState GetMousePointerEventData(int id)
        {
            ...
            if(actionEventSystem != null)
            {
                actionEventSystem.RaycastCamera(leftData, m_RaycastResultCache);
            }
