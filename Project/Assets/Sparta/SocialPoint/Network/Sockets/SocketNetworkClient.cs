...
{
    public abstract class SocketNetworkClient : INetworkClient, IDisposable
    {
        public const string DefaultServerAddr = "localhost";

        protected List<INetworkClientDelegate> _delegates = new List<INetworkClientDelegate>();
        protected INetworkMessageReceiver _receiver;
        protected string _serverAddr;
        protected int _serverPort;

        public SocketNetworkClient(string serverAddr = null, int serverPort = UnetNetworkServer.DefaultPort)
        {
        ...
        {
            UnityEngine.Debug.Log("SocketNetworkClient AddDelegate");
            _delegates.Add(dlg);
        }

        public void RemoveDelegate(INetworkClientDelegate dlg)
        {
            UnityEngine.Debug.Log("SocketNetworkClient RemoveDelegate");
            _delegates.Remove(dlg);
        }

        public void RegisterReceiver(INetworkMessageReceiver receiver)
        {
            UnityEngine.Debug.Log("SocketNetworkClient RegisterReceiver");
            _receiver = receiver;
            UnityEngine.Debug.Log(_receiver.ToString());
        }

        public virtual int GetDelay(int networkTimestamp)
        {
            throw new NotImplementedException();
        }

        public virtual  byte ClientId
        {
            get
            {
                throw new NotImplementedException();
