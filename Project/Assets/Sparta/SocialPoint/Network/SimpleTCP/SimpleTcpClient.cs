...
//			{
//				MessageEventArgs m = new MessageEventArgs(msg, client, StringEncoder, Delimiter, AutoTrimStrings);
...
//		}
//
//		public MessageEventArgs WriteLineAndGetReply(string data, TimeSpan timeout)
//		{
//			MessageEventArgs mReply = null;
