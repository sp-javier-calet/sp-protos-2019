...
namespace BehaviorDesigner.Runtime
{
    ...
    public class BehaviorSource : IVariableSource
    {
...
#if BEHAVIOR_DESIGNER_STANDALONE
        public BinaryDeserialization binaryDeserialization = null;
#endif
        ...
        public object Clone()
        {
            ...
            BehaviorDesigner.Runtime.Standalone.BehaviorSourceSerializer.Instance.Serialize(this, writer);
            stream.Seek(0, System.IO.SeekOrigin.Begin);
            var reader = new SystemBinaryReader(stream);
            var source = new BehaviorSource();
#if BEHAVIOR_DESIGNER_STANDALONE
            source.binaryDeserialization = binaryDeserialization;
#endif
            BehaviorDesigner.Runtime.Standalone.BehaviorSourceSerializer.Instance.Deserialize(source, reader);
            return source;
        }
...
#else
                    BinaryDeserialization.Instance.Load(mTaskData, behaviorSource == null ? this : behaviorSource);
#endif
                }
                return true;
            }
