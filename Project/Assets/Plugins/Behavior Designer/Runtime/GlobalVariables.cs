...
{
    public static class GlobalVariablesBuilder
    {
...
#if !BEHAVIOR_DESIGNER_STANDALONE
            gv = Resources.Load("BehaviorDesignerGlobalVariables", typeof(GlobalVariables)) as GlobalVariables;
#endif
            if (gv != null)
            {
                gv.CheckForSerialization(false);

#if ENABLE_MULTIPLAYER && !BEHAVIOR_DESIGNER_STANDALONE
                if (UnityEngine.Networking.NetworkServer.active) {
                    ...
                    var variables = gv.GetAllVariables();
    ...
    public class GlobalVariables : ScriptableObject, IVariableSource
    {
        ...
        public static GlobalVariables Instance
        {
            get
            {
                if (instance == null)
                {
                    instance = GlobalVariablesBuilder.Create();
                }
                return instance;
            }
        }
...
#else
                    BinaryDeserialization.Instance.Load(this, mVersion);
#endif
                }
            }
        }
