...
namespace BehaviorDesigner.Runtime.Tasks
{
    ...
    public abstract class Task
    {
        ...
        public Behavior Behavior { set { behavior = value; } }
        protected Behavior behavior;

        public BehaviorManager BehaviorManager { set { behaviorManager = value; } }
...
#endif
        {
            return behavior.GetComponent<T>();
        }
        protected object GetComponent(System.Type type)
        {
