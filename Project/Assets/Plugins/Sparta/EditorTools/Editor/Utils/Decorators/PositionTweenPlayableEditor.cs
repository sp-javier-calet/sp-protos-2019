...
{
    [CustomEditor(typeof(PositionTweenPlayableClip))]
    public class PositionTweenPlayableInspector : UnityEditor.Editor
    {
        public override void OnInspectorGUI()
        {
            serializedObject.Update();

            var playableTarget = (PositionTweenPlayableClip)target;
