...
{
    public class UnityStandaloneInputModule : PointerInputModule
    {
        ...
        protected void ProcessTouchPress(PointerEventData pointerEvent, bool pressed, bool released)
        {
            ...
            if (pressed)
            {
                ...
                if (pointerEvent.pointerDrag != null)
                {
                    ...
                    ExecuteEvents.Execute(gameObject, pointerEvent, ExecuteEvents.initializePotentialDrag);
                }
            }
            ...
            if (released)
            {
                ...
                else if (pointerEvent.pointerDrag != null && pointerEvent.dragging)
                {
                    ...
                    ExecuteEvents.Execute(gameObject, pointerEvent, ExecuteEvents.dropHandler);
                }
                ...
                if (pointerEvent.pointerDrag != null && pointerEvent.dragging)
                {
                    ...
                    ExecuteEvents.Execute(gameObject, pointerEvent, ExecuteEvents.endDragHandler);
                }
        ...
        protected bool SendSubmitEventToSelectedObject()
        {
            ...
            if (input.GetButtonDown(m_CancelButton))
            {
                ...
                ExecuteEvents.Execute(gameObject, data, ExecuteEvents.cancelHandler);
            }
            return data.used;
        }
        ...
        protected bool SendMoveEventToSelectedObject()
        {
            ...
            if (axisEventData.moveDir != MoveDirection.None)
            {
                ...
                ExecuteEvents.Execute(gameObject, axisEventData, ExecuteEvents.moveHandler);
        ...
        protected void ProcessMouseEvent(int id)
        {
            ...
            if (!Mathf.Approximately(leftButtonData.buttonData.scrollDelta.sqrMagnitude, 0.0f))
            {
                ...
                ExecuteEvents.Execute(gameObject, leftButtonData.buttonData, ExecuteEvents.scrollHandler);
            }
        }
        ...
        protected bool SendUpdateEventToSelectedObject()
        {
            ...
            ExecuteEvents.Execute(gameObject, data, ExecuteEvents.updateSelectedHandler);
            return data.used;
        }
