...
namespace LiteNetLib
{
    ...
    public sealed class NetPeer
    {
        ...
        internal NetPeer(NetManager peerListener, NetEndPoint remoteEndPoint, long connectId)
        {
            ...
            {
                // UnityEngine.Debug("*********CONNECTED " +DateTime.Now.Ticks);
        ...
        internal void Update(int deltaTime)
        {
            ...
            // UnityEngine.Debug("*********STATE " + _connectionState+ " " +DateTime.UtcNow);
            ...
            if (_connectionState == ConnectionState.InProgress)
            {
                ...
                if (_connectTimer > _peerListener.ReconnectDelay)
                {
                    ...
                    {
                        // UnityEngine.Debug("*********DISCONNECT "+_peerListener.ReconnectDelay + " "+_connectAttempts + " "+_peerListener.MaxConnectAttempts + " " +DateTime.UtcNow);
