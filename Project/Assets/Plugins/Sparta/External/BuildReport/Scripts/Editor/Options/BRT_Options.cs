...
public static class Options
{
	...
	public const string BUILD_REPORT_TOOL_DEFAULT_PATH = "Assets/Sparta/External/BuildReport";
    public const string BUILD_REPORT_TOOL_DEFAULT_FOLDER_NAME = "Sparta/External/BuildReport";
