...
namespace Jitter.LinearMath
{
    ...
    public struct JQuaternion
    {
        ...
        public static void Lerp(ref JQuaternion valueFrom, ref JQuaternion valueTo, float percent, out JQuaternion result)
        {
            ...
            result.W = valueFrom.W + (valueTo.W - valueFrom.W) * percent;
        }
        ...
        public static JVector operator *(JQuaternion quat, JVector vec)
        {
            float num = quat.X * 2f;
        ...
        public static JQuaternion LookAt(JVector direction)
        {
