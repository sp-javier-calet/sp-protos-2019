...
// --------------
	...
	public  Vector2		posPx = new Vector2(100, 100);	/// Current static/dynamic position
	private float		radPx = 40;

	#region DL vars
	public bool 		DLFollowFinger = true;
	public bool 		DLFollowDelay = false;
	public bool 		DLAnchored = true;
	public bool 		DLDisappear = false;
...
//		}
	...
	{ 
		...
		{
			this.posPx = new Vector2(Screen.width * 0.2f, Screen.height * 0.7f);
		}
	}
...
#		endif
	...
	override public void OnUpdate(bool firstUpdate)
		...
		{
			this.posPx = Vector2.Lerp (this.posPx, new Vector2(Screen.width * 0.2f, Screen.height * 0.7f), 0.05f);
		}
