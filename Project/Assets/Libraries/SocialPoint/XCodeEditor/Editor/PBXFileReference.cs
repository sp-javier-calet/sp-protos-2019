...
namespace SocialPoint.XCodeEditor
{
    public class PBXFileReference : PBXObject
    {
        ...
        public PBXFileReference(string filePath, TreeEnum tree = TreeEnum.SOURCE_ROOT) : this(filePath, null, tree)
        {
        }

        public PBXFileReference(string filePath, string name, TreeEnum tree = TreeEnum.SOURCE_ROOT) : base()
        {
            if(name == null)
            {
