...
namespace BM.Extensions
{
    ...
    {
        #if UNITY_ANDROID
        private const string PlatformSuffix = "_Android";

#else
        private const string PlatformSuffix = "";
        #endif
        ...
        static string _assetVersionJson = Path.Combine(Application.streamingAssetsPath, "json/localAssetVersioningJson" + PlatformSuffix + ".json");
        static string _assetVersionJsonBackup = Path.Combine(Application.streamingAssetsPath, "json/localAssetVersioningJsonPreviousVersion.json");
        ...
        static public void ExportToJson()
        {
            ...
            LoadAssetVersioningJson(_assetVersioningDictBackup, _assetVersionJsonBackup);
            ...
            foreach(BundleBuildState bundle in BundleManager.buildStates)
            {
                ...
                else
                {
                    ...
                    //TODO remove forcing local bundles when using data from SPAM server
                    //newBundle["isLocal"] = new AttrBool(false);
            ...
            //TODO Temporary code, remove when we have backend 
