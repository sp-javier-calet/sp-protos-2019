...
/*
 * After you've resized a GUI element, positioning anchors to corners precisely can be difficult. 
 * With this script you can automatically position them from the menu or by pressing ctrl + [ , and do the reverse (corners to anchors) with ctrl + ] . 
 * Place the script in the Editor folder.
*/
