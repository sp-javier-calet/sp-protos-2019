...
static PyObject* CompressLzo1xAlloc(PyObject* dummy, PyObject* args)
{
    ...
    {
        PyErr_SetString(distcc_pump_c_extensionsError, "Couldn't compress that.");
        return NULL;
    }
...
static char RCwd_doc__[] =
  ...
  "   Raises:\n"
  "     distcc_pump_c_extensions.Error\n";
static PyObject* RCwd(PyObject* dummy, PyObject* args)
{
    int ifd;
    char* value_str;
    UNUSED(dummy);
    ...
    {
        PyErr_SetString(distcc_pump_c_extensionsError, "Couldn't read token string.");
        return NULL;
    }
...
static char RTokenString_doc__[] =
  ...
  "   Raises:\n"
  "     distcc_pump_c_extensions.Error\n";
static PyObject* RTokenString(PyObject* dummy, PyObject* args)
{
    int ifd;
    char* expect_token;
    char* value_str;
...
static char RArgv_doc__[] =
  ...
  ;
static PyObject* RArgv(PyObject* dummy, PyObject* args)
{
    int i = 0;
    ...
    if((list_object = PyList_New(0)) == NULL)
        goto error;
    for(; argv[i]; i++)
    {
...
static PyObject* XArgv(PyObject* dummy, PyObject* args)
{
    int i;
    char** ptr;
...
static PyObject* OsPathExists(PyObject* dummy, PyObject* args)
{
    const char* in;
    int len;
    int res;
...
static PyObject* OsPathIsFile(PyObject* dummy, PyObject* args)
{
    const char* in;
    int len;
    int res;
...
static PyObject* Realpath(PyObject* dummy, PyObject* args)
{
    const char* in;
...
static PyMethodDef methods[] = {{"OsPathExists", (PyCFunction)OsPathExists, METH_VARARGS, OsPathExists_doc__},
                                {"OsPathIsFile", (PyCFunction)OsPathIsFile, METH_VARARGS, OsPathIsFile_doc__},
                                {"Realpath", (PyCFunction)Realpath, METH_VARARGS, Realpath_doc__},
                                {"RTokenString", (PyCFunction)RTokenString, METH_VARARGS, RTokenString_doc__},
                                ...
                                {"CompressLzo1xAlloc", (PyCFunction)CompressLzo1xAlloc, METH_VARARGS, CompressLzo1xAlloc_doc__},
                                {NULL, NULL, 0, NULL}};


static /* const */ char module_documentation[] = "Various utilities for distcc-pump.\n";

void initdistcc_pump_c_extensions(void)
{
    PyObject* module;
    PyObject* py_str;
    distcc_pump_c_extensionsError = PyErr_NewException((char*)"distcc_pump_c_extensions.Error", NULL, NULL);

    module = Py_InitModule4("distcc_pump_c_extensions", methods, module_documentation, NULL, PYTHON_API_VERSION);
    ...
    PyModule_AddObject(module, "Error", distcc_pump_c_extensionsError);
}
