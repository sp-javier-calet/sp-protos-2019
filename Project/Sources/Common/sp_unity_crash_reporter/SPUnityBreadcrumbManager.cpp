...
std::string SPUnityBreadcrumbManager::dumpToFile() const
{
...
std::string SPUnityBreadcrumbManager::dumpToFile(const std::string& directory, const std::string& file) const
{
